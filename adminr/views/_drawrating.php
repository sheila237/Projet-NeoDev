...
--------------------------------------------------------- */
	...
	function rating_bar($page_id, $units='', $static='') {
		...
		require_once ('connect.inc.php'); // get the db connection info
		...
		if ($count == 0) {
			$req = "INSERT INTO `produit`.`ratings` (`vote_id` ,`page_id` ,`total_votes` ,`total_value` ,`used_ips` ) VALUES (NULL , '".$page_id."', '0', '0', NULL);";
